...
parser.add_argument("--task", type=str, default='ft_cls', help="pretraining or fine-tuning task", choices=["ft_avgtok", "ft_cls", "ft_asr", "ft_avgtok_weighted", "ft_asr_weighted", "ft_pr_weighted", "pretrain_mpc", "pretrain_mpg", "pretrain_joint", "pretrain_mpj", "pretrain_mpmhb", "probe_asr", "probe_pr", "probe_sid"])
...
# in the fine-tuning stage
    ...
    ast_model = ASTModel(label_dim=args.n_class, fshape=args.fshape, tshape=args.tshape, fstride=args.fstride, tstride=args.tstride,
                         ...
                         num_clusters=args.num_clusters, vocab_size=args.n_class, blank_model=args.blank_model)
