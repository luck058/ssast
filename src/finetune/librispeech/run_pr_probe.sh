#!/bin/bash
#SBATCH --job-name="ssast-pr-probe"
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
exp_dir=./exp/probe-pr-${dataset}-f${fstride}-t${tstride}-b${batch_size}-lr${lr}-${task}-${model_size}-${pretrain_model}

echo "Starting Probe PR Training..."
